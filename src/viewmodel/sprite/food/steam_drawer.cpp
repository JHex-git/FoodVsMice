...
// projectile
const int PROJECTILE_PADDING_X = 20; // 发射点的delta
const int PROJECTILE_PADDING_Y = 10;
const int PROJECTILE_DELTA_X = -20; // 图片的delta
const int PROJECTILE_DELTA_Y = 10;
const int PROJECTILE_START = 18;
const int PROJECTILE_BOOM = 19;
const int PROJECTILE_VELOCITY = 500;
const int PROJECTILE_DAMAGE = 20;
const int PROJECTILE_LEN = 20; // 太小会穿过

bool SteamDrawer::CheckFunc()
{
    return mouse_manager->GetLeftestMouse(center_x, row) != nullptr;
}

void SteamDrawer::Func()
{
...
SteamDrawer::SteamDrawer(int x, int y, int row, int column, std::vector<QPixmap *> frames, MouseManager *mouse_manager, ProjectileManager *projectile_manager)
