...
Food::Food(int x, int y, int delta_x, int delta_y, int row, int column, int left_padding, int right_padding, std::vector<QPixmap *> frames, int func_start_index, int func_take_effect_index, int projectile_index, int health, float cool_down_time) :
