...
const int COOL_DOWN_TIME = 0;
const int HEALTH = 100;
const int DELTA_X = 25;
const int DELTA_Y = 33;
const float FRAME_RATE = 1;
const int FUNC_START_INDEX = 11;
const int FUNC_TAKE_EFFECT_INDEX = 14;
const int LEFT_PADDING = 20;
const int RIGHT_PADDING = 20;

// projectile
const int PROJECTILE_PADDING_X = 20; // 发射点的delta
const int PROJECTILE_PADDING_Y = 20;
...
Fish::Fish(int x, int y, int row, int column, std::vector<QPixmap *> frames, MouseManager *mouse_manager, ProjectileManager *projectile_manager)
